    ...
    <div className="container" style={{ padding: '2rem' }}>
      ...
      <div style={containerStyle}>
        ...
        <div style={{ textAlign: 'right' }}>
          <img src="src\images\gosals1.png" alt="Gosals1" style={imageStyle} />
        </div>
        <div style={{ textAlign: 'right' }}>
          <img src="src\images\gosals2.png" alt="Gosals2" style={imageStyle} />
        </div>
        <div style={textContainerStyle}>
          <p style={{ color: 'black', fontSize: '1.2rem', marginBottom: '0.5rem' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <img src="src\images\gosals3.png" alt="Pizza 3" style={imageStyle} />
        </div>
      </div>
    </div>
    </>
